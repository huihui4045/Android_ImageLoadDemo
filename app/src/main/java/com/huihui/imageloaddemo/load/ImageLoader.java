...
import com.huihui.imageloaddemo.R;
import com.huihui.imageloaddemo.io.DiskLruCache;
...
public class ImageLoader {
    ...
    private static final int TAG_KEY_URI = R.id.spread_inside;
     ...
     * @param reqHeight
     */
    public void loadBitmap(final String uri, final ImageView imageView, final int reqWidth, final int reqHeight) {
